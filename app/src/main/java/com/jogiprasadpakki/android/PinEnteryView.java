package com.jogiprasadpakki.android;
 ...
 */
public class PinEnteryView extends AppCompatEditText {
    ...
    public PinEnteryView(Context context) {
        super(context);
    }

    public PinEnteryView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public PinEnteryView(Context context, AttributeSet attrs, int defStyleAttr) {
